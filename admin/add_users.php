...
{
    if( empty($_POST['fname'])|| empty($_POST['lname']) ||empty($_POST['email'])||empty($_POST['phone'])||empty($_POST['age'])||empty($_POST['license']) ||empty($_POST['password'])||empty($_POST['con-password'])
		)
		{
	...
	elseif(strlen($_POST['con-password']) < 6)
    {
        $error = '<div class="alert alert-danger alert-dismissible fade show">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <strong>Password must be >=6!</strong>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="age" class="form-control form-control-danger" placeholder="Age">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Driving Liense Number</label>
                                                    <input type="text" name="license" class="form-control form-control-danger" placeholder="Driving Lience Number">
                                                    </div>
                                                </div>
                                            </div>
                                        <!--/row-->
										 <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="con-password" class="form-control form-control-danger" placeholder="confirm password">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
