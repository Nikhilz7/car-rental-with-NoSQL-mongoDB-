                                                       ...
                                                       if ($row->car_availability=='yes') 
                                                        {
                                                           echo '<tr>
																	...
																	<td><a href="delete_menu.php?menu_del='.$row->car_name.'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																	    <a href="update_menu.php?menu_upd='.$row->car_name.'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
                                                                    </td>
                                                                </tr>';									
                                                        }
                                                    }
